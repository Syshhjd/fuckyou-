...
async (conn, mek, m, {
    ...
    try {
        if (!isGroup) return reply("⛔️ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ɪɴ ɢʀᴏᴜᴘs.");

        if (!isOwner && !isAdmins) {
            return reply("⛔️ ᴏɴʟʏ ᴛʜᴇ ʙᴏᴛ ᴏᴡɴᴇʀ ᴏʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.");
        }

        if (!isBotAdmins) {
            return reply("ɪ ɴᴇᴇᴅ to ʙᴇ an ᴀᴅᴍɪɴ to ᴇxᴇᴄᴜᴛᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.");
        }
