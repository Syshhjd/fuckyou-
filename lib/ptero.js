...
// ---- CREATION SERVEUR ----
const DEFAULT_NODE = 1; // À adapter si besoin
const DEFAULT_ALLOCATION = 1; // À adapter si besoin

const DEFAULT_NEST = "0bcaf5d1-49ba-457f-9eaa-cff848193562";
const DEFAULT_EGG = "d3e19eb1-2a7e-441a-9b9c-6e1dc0680eb8";
...
async function powerClientServer(serverName, signal) {
  try {
    ...
    // Traduction automatique de l'erreur d'API key
    if (
      e.response?.data?.errors?.[0]?.detail &&
