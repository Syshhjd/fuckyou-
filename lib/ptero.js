...
// ---- CREATION SERVEUR ----
// À ADAPTER si tu veux changer node ou allocation (voir Panel > Nodes/Allocations)
const DEFAULT_NODE = 1;
const DEFAULT_ALLOCATION = 1;

const DEFAULT_NEST = 5;    // ID numérique, PAS UUID
const DEFAULT_EGG = 15;    // ID numérique, PAS UUID
